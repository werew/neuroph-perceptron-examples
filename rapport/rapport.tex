...
Pour l'apprentissage de la fonction carré nous allor donc utiliser un perceptron
...
Pour commencer on pourra utiliser un perceptron avec 3 neurons cache comme celui que
on a utilise pour l'equivalence. Notre mission sera de approximer la fonction 
carre dans l'intervalle $[1,100]$.
